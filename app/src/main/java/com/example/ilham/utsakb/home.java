...
import com.example.ilham.utsakb.presenter.MainActivityPresenter;
import com.example.ilham.utsakb.view.FriendView;
import com.example.ilham.utsakb.view.tab.MyAdapter;
import com.example.ilham.utsakb.view.tab.SlidingTabLayout;
...
public class home extends AppCompatActivity
    ...
    public void tweet(View view) {
        ...
        {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://twitter.com/pratamailham_")));
        }
    }
